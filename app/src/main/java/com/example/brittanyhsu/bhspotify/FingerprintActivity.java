...
/*
TODO: Try to slim it down even more
 */
...
//            public void onClick(View v) {
//                AlertDialog.Builder alert = new AlertDialog.Builder( FingerprintActivity.this );
//
...
//            public void onClick(View v) {
//                startActivity(new Intent(FingerprintActivity.this, HistoryDetails.class));
//            }
//        });
...
//        Log.d(appString, "updateMetaDataFields called");
//        LayoutInflater inflater = (LayoutInflater) getSystemService(Context.LAYOUT_INFLATER_SERVICE);
...
//            detailView = new DetailView(album, FingerprintActivity.this);
//
//        }
//
//        @Override
